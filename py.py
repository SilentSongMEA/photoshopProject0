...
goto(0,240)
turtle.write(" ROCK PAPAER SCISSPRS",align='center',font=("tahoma",30))
...
while True:
    ...
    vorodi=turtle.textinput("R S P","PLEASE ENTER : R =ROCK , P= PAPAER , S=SCISSORS")
    if vorodi.lower()=="r":
        goto(170,-190)
        turtle.circle(100)
    elif vorodi.lower()=="p":
